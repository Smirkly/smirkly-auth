...
class AuthService {
 public:
  AuthService(ports::TransactionManager& transaction_manager,
  ...
  void RequestPasswordReset(const contracts::RequestPasswordResetCommand& cmd,
                            const contracts::RequestMeta& meta = {});

  void ConfirmPasswordReset(const contracts::ConfirmPasswordResetCommand& cmd,
                            const contracts::RequestMeta& meta = {});
 ...
 private:
  ...
  ports::security::TokenGenerator& password_reset_token_generator_;
